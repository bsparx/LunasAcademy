...
import type { Certificate } from "@/app/learn/_data/progress-content";
          ...
          {certificate.nextCourse ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="mt-0.5 text-[15px] font-semibold text-[var(--color-ink-900)]">
                    Next in Core: <span className="text-[var(--color-mint-600)]">{certificate.nextCourse.title}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 flex items-center justify-between rounded-2xl border border-[var(--color-mint-500)]/40 bg-[var(--color-tint-green)]/30 p-5">
              <div>
                ...
                <div className="mt-0.5 text-[15px] font-semibold text-[var(--color-ink-900)]">
                  Time to pick a specialist track.
                </div>
              </div>
              <Link
                href="/tracks"
              ...
              >
                Choose a specialty <ArrowRight className="h-3.5 w-3.5" />
              </Link>
            </div>
          )}
        </div>
